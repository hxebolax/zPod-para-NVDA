...
addon_info = {
	...
	"addon_summary": _("zPod para NVDA"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	"addon_description": _("Previsualiza archivos multimedia rápidamente"),
	# version
	"addon_version": "0.3.1",
	# Author(s)
	"addon_author": u"Héctor J. Benítez Corredera <xebolax@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/hxebolax/zPod-para-NVDA",
...
pythonSources = [os.path.join("addon", "globalPlugins", "zPod", "*.py")]
